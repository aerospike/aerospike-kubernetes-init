...
require (
	github.com/aerospike/aerospike-kubernetes-operator v0.0.0-20230804084225-f7a699b0940d
...
require (
	github.com/aerospike/aerospike-management-lib v0.0.0-20230803080950-65d07e4ee37c // indirect
